 ...
 */
@WebServlet("/Controlador_ActualizaUsuarioJS")
public class Controlador_ActualizaUsuarioJS extends HttpServlet {
     ...
     */
    public Controlador_ActualizaUsuarioJS() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if (usuario != "" && contrasena != "") {
				...
				try {
					...
					if (us != null) {
						...
						request.setAttribute("button", but);
						//aquí devolver los parámetros a la vistaActualiza con un indicador de login ok
						request.getRequestDispatcher("vistasUsuario/actualizaUsuarioJS.jsp").forward(request, response);
		...
		} else if (request.getParameter("botonActualiza") != null) {//Primera condición para elegir botón
