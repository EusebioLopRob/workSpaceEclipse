...
<form action="${pageContext.request.contextPath}/Controlador_ActualizaUsuarioJS" method="post">
		...
		<br />
		<p>
			<input type="submit" value="Actualiza Usuario" name="botonActualiza" disabled=false></input>
		</p>		
